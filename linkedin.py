...
# Shared account to login to LinkedIn
username = ''
password = ''
...
def readurls():
    # Place all company profile urls here
    companyurls = ['https://www.linkedin.com/company/nvidia/']
    extracted_data = []
    for url in companyurls:
        extracted_data.append(linkedin_scraper(url))
        f = open('linkedin_data.json', 'w')
